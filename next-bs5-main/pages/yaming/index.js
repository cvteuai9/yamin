      ...
      <div className="shane-body">
        ...
        <div className="container">
          <div className="shane-star mt-5 mb-5 mx-5">
            <img src="/images/yaming/index/star.png" alt="" width={16} height={16} />
            <img
        ...
        <div className="container mb-5">
          <div className="d-flex justify-content-center mb-1">
            <img src="/images/yaming/index/上.png" alt="" width={80} height={8} />
          </div>
          ...
          <div className="d-flex justify-content-center mb-1">
            <img src="/images/yaming/index/下.png" alt="" width={80} height={8} />
          </div>
        </div>
          ...
          <div className="row d-flex justify-content-center align-items-center ms-2 me-2">
            <div className=".col-12 shane-store1 col-sm-6 col-md-3  text-center ">
              ...
              <div className="shane-star2">
                <img src="/images/yaming/index/star.png" alt="" className="star3" />
