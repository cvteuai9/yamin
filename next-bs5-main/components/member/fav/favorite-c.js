...
export default function FavoriteC() {
  ...
  async function handleFavCancel(id) {
    ...
    if (agreeDelete) {
      await fetch(
        `http://localhost:3005/api/course/favorites?user_id=1&course_id=${id}`,
        { method: 'DELETE' }
      )
        .then((res) => res.json())
        .then((result) => {
          ...
          <div className="row">
            ...
            <div className="col-md-9 p-0">
              ...
              <div className={`${styles.favoriteCourseGroup} mt-5`}>
                {course.map((v, i) => {
                  return (
                    <div className={`${styles['favoritec-cards']}`} key={v.id}>
                      <div className={`${styles['favoritec-pcard']}`}>
                        ...
                        <div className={`${styles['favoritec-cardtext']}`}>
                          ...
                          >
                            ...
                            <div className={`${styles.courseDescription} p2 whitef50`}>
                              <p>{v.description}</p>
                            </div>
                            <div
                            ...
                            >
                              ...
                              <p className="p2 classdate ms-3">
                                人數限制 {v.limit_people} 人：已經報名 {v.current_number} 人
                              </p>
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div>
                              <i
                                ...
                                style={{ color: '#ffffff' }}
                              />
                              <p className="mb-0 ms-3 p2 whitef">{v.location}</p>
                            </div>
                            <div>
